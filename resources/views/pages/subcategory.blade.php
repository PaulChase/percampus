...
{{-- this view is for subcategories that is specific to a campus --}}
<section class="py-6 px-3 max-w-7xl mx-auto">
    <div class=" grid grid-cols-2  lg:grid-cols-3 gap-4 text-center">
        
        @foreach ($subCategories as $subcategory)
        
                <a href="{{ route('campus.posts.bycategory', ['campus' => $campus->nick_name,'m' => $mainCategory->name, 'c' => $subcategory->slug ])}}" class=" border-2  border-gray-200 focus:border-green-700 rounded-md p-3">
