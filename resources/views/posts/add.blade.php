...
@section('content')
    ...
    <div class="bg-gray-100 py-4">
        ...
        <div class="px-4 py-4 md:max-w-lg mx-auto md:shadow-lg rounded-md bg-white">
            ...
            <form method="POST" action="{{ route('posts.save')}}" enctype="multipart/form-data" class=" space-y-4 text-gray-500">
                ...
                <div class="">
                    <label for="campus" class="font-semibold">Select the category of the item <b class=" text-red-500">*</b> <br> <small>note you can't change this later</small></label>           
                ...
                <div>
                    ...
                    <input type="text" class="  p-2 bg-gray-100 rounded-lg w-full mt-1  focus:outline-none focus:ring-2 focus:ring-green-200" name="price" placeholder=" e.g 2,500 or 2 500" required>
                    @error('price')
