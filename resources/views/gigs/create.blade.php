  ...
  <div class="bg-gray-100 py-4">
    ...
    <div class="px-4 py-4 md:max-w-lg mx-auto md:shadow-lg rounded-md bg-white">
      ...
      <form method="POST" action="{{ route('gigs.store') }}" enctype="multipart/form-data"
        ...
        <div>
          <label for="description" class="font-semibold">Tell us more about the Service <b
              class=" text-red-500">*</b></label><br>
          <textarea name="description" id="" cols="30" rows="7"
            class="  p-2 bg-gray-100 rounded-lg w-full mt-1  focus:outline-none focus:ring-2 focus:ring-green-200"
            placeholder="Provide more details about the Service such as experience level additional bonuses etc. This is your chance to convice the client to contact you">{{ old('description') }}</textarea><br>
          @error('description')
            <small class="bg-red-300 p-2 inline-block rounded-sm text-sm mt-1">{{ $message }}</small>
          @enderror
        </div>
        <div class="">
          <label for="" class="font-semibold">Choose the Category of the Service<b class=" text-red-500">*</b> <br>
        ...
        @else
          <div>
            <label for="price" class="font-semibold">The lowest price you charge per Service <b class=" text-red-500">*</b></label>
            <input type="number"
              class="  p-2 bg-gray-100 rounded-lg w-full mt-1  focus:outline-none focus:ring-2 focus:ring-green-200"
