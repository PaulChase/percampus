    ...
    <div class="px-4 py-4 md:max-w-lg mx-auto md:shadow-lg rounded-md bg-white ">
      ...
      <div class="  " id="signup">
        <form method="POST" action="{{ route('register') }}" class=" space-y-4">
          ...
          <div class="  ">
            <label for="name" class=" text-gray-800"> <i class=" fa fa-user text-gray-500 mr-2"></i> what's that your fine
              name?</label>
          ...
          <div class="  ">
            <label for="phone" class=" text-gray-800"><i class=" fa fa-mobile text-gray-500 mr-2"></i> Your phone number
