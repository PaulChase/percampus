...
@section('content')
    ...
    <div class="bg-gray-100 py-4">
        ...
        <div class="px-4 py-4 md:max-w-lg mx-auto md:shadow-lg rounded-md bg-white">
            ...
            <form method="POST" action="{{ route('ads.update', ['id' => $ad->id])}}" enctype="multipart/form-data" class=" space-y-4">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                <div>
                    
                    <label for="">title of the Ad <b class=" text-red-500">*</b></label><br>
                    <input name="title" type="text" class="  p-2 bg-gray-100 rounded-lg w-full mt-1  focus:outline-none focus:ring-2 focus:ring-green-200" placeholder="enter a catchy title for the ad" value="{{ $ad->title}}"><br>
                    @error('title')
                ...
                <div>
                    ...
                    <input name="url" type="url" class="  p-2 bg-gray-100 rounded-lg w-full mt-1  focus:outline-none focus:ring-2 focus:ring-green-200" placeholder="enter a valid url" value="{{ $ad->link}}"><br>
                    @error('title')
                        <small class="bg-red-300 p-2 inline-block rounded-sm text-sm mt-1">please enter a valid title</small>
                    @enderror
                </div>
